<template>
    <div style="width: 100%;height: 100%;">
      <div style="width:100%;height:40px;border-bottom: 1px solid #103665;border-top: 1px solid #103665;display: flex;align-items: center;">
        ...
        <div class="fontStyle">PUE排行</div>
        <div class="endStyle" style="margin-left: 62%;"></div>
        <div class="endStyle" style="margin-left: 3%;"></div>
      </div>
      <div style="width:100%;height:30%;">
        <DynamicEnergyRight01 :siteId="siteId"></DynamicEnergyRight01>
      </div>
      <div style="width:100%;height:40px;border-bottom: 1px solid #103665;border-top: 1px solid #103665;display: flex;align-items: center;">
        <div class="titleStyle"></div>
        <div class="fontStyle">能耗排行</div>
        <div class="endStyle" style="margin-left: 62%;"></div>
        <div class="endStyle" style="margin-left: 3%;"></div>
      </div>
      <div style="width:100%;height:30%;display: flex;">
        <DynamicEnergyRight02 :siteId="siteId"></DynamicEnergyRight02>
      </div>
      <div style="width:100%;height:40px;border-bottom: 1px solid #103665;border-top: 1px solid #103665;display: flex;align-items: center;">
        <div class="titleStyle"></div>
        <div class="fontStyle">耗电量月对比</div>
        <div class="endStyle" style="margin-left: 53%;"></div>
        <div class="endStyle" style="margin-left: 3%;"></div>
      </div>
      <div style="width:100%;height:28%;display: flex;">
        <DynamicEnergyRight03 :planId="planId"></DynamicEnergyRight03>
      </div>
    </div>
</template>
...
import DynamicEnergyRight01 from "./DynamicEnergyRight01";
import DynamicEnergyRight02 from "./DynamicEnergyRight02";
import DynamicEnergyRight03 from "./DynamicEnergyRight03";
import echarts from 'echarts/lib/echarts'
export default {
  components: {
    right01,
    DynamicEnergyRight01,
    DynamicEnergyRight02,
    DynamicEnergyRight03
  },
  props: ['planId','siteId'],
  data() {
    return {
