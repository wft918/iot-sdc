<template>
  <div style="width:100%;height:100%;display: flex;align-items: center;">
    <div ref="pueTrendChart" id="pueTrendChart" class="pueTrendChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    async queryPageData() {
      getPueTrend({planId: this.planId}).then((res) => {
        if (res.data.code === 0) {
    ...
    init(){
      ...
      let pueTrendChart = this.$echarts.init(this.$refs.pueTrendChart);
