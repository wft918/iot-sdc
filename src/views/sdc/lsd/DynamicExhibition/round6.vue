<template>
  <div style="width:100%;height:100%;display: flex;align-items: center;">
    <div ref="round6" class="emgCountChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
        ...
        let round6 = this.$echarts.init(this.$refs.round6);
        round6.setOption(option);
    }
  }
};
</script>
