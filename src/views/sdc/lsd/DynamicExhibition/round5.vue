<template>
  <div style="width: 100%; height: 100%; display: flex; align-items: center">
    <div ref="round5" class="emgCountChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // for (
      //   let index = 0;
      //   index < this.mainPollutantsInfo.groupname.length;
      //   index++
      // ) {
      //   const el = this.mainPollutantsInfo.groupname[index];
      //   trafficWay.push({
      //     name: el,
      //     value: this.mainPollutantsInfo.value[index],
      //   });
      // }
      ...
      var color = [
        ...
        "#00fcf5",
        "#c79ffc",
      ]; //['#00ffff', '#00cfff', '#006ced', '#ffe000', '#ffa800', '#ff5b00', '#ff3000']
      ...
      let round5 = this.$echarts.init(this.$refs.round5);
      round5.setOption(option);
    },
  },
};
</script>
