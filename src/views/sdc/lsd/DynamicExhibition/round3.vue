<template>
  <div style="width:100%;height:100%;display: flex;align-items: flex-end;">
    <div ref="round3" class="emgCountChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      ...
      let round3 = this.$echarts.init(this.$refs.round3);
      round3.setOption(option);
        let that = this
      setTimeout(function(){
        that.tempId4 = setInterval(function(){
