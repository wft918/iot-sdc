<template>
  <div style="width:100%;height:100%;display: flex;align-items: flex-end;">
    <div ref="round2" class="emgCountChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      ...
      let round2 = this.$echarts.init(this.$refs.round2);
      round2.setOption(option);
        let that = this
      setTimeout(function(){
        that.tempId3 = setInterval(function(){
