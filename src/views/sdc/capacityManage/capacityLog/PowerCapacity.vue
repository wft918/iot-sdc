...
import { getCapacityPowerLog } from "@/api/sdc/capacityManage";
...
export default {
  ...
  computed: {
    ...
    methods: {
       ...
       * 网络请求
       */
      _getCapacityPowerLog(params) {
        getCapacityPowerLog(params).then(res => {
          console.log(res);
          if (res.data.code === 0) {
      ...
      async getSiteData() {
        ...
        this._getCapacityPowerLog(this.queryCondition)
        this.$nextTick(() => {
