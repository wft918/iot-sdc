...
import { getCapacityRackLog } from "@/api/sdc/capacityManage";
...
export default {
  ...
  computed: {
    ...
    methods: {
       ...
       * 网络请求
       */
      _getCapacityRackLog(params) {
        getCapacityRackLog(params).then(res => {
          console.log(res);
          if (res.data.code === 0) {
      ...
      async getSiteData() {
        ...
        this._getCapacityRackLog(this.queryCondition)
        this.$nextTick(() => {
