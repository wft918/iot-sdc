        ...
        <el-col :span="24" style="margin-top:20px">
            ...
            >
              ...
              <el-table-column 
                ...
                align="center"
              ></el-table-column>
              <!-- <el-table-column  label="终端列表" prop="contactsName" align="center">
              </el-table-column > -->
              <el-table-column  
                label="终端列表" 
              ...
              <el-table-column  label="修改时间" prop="updateDate" align="center">
              </el-table-column >
        ...
        >
          ...
          <el-form-item label="动作" prop="action">
            <el-radio-group v-model="inputForm.action" >
              <el-radio :label="'01'">开灯</el-radio>
              <el-radio :label="'02'">关灯</el-radio>
              <el-radio :label="'03'">调光</el-radio>
            </el-radio-group>
            <el-input v-model="inputForm.param" type="text" placeholder="输入调光值" style="width:120px"></el-input>
          </el-form-item>
  ...
  methods: {
    ...
    async tableAction(row,flag) {
      ...
      if(flag === 3) {  //查看
        ...
        let tableData = await getSdcLightLampsTable(this.queryPolicyCondition);
        let result = clearData(tableData.data.data.records,row.expand.targetIds)
        const promise = result.map( el => {
    ...
    doChange(val) {
      ...
      switch (val) {
        case 1:
          this.inputForm.action = '01'
          break;
        case 2:
          this.inputForm.action = '02'
          break;
        case 3:
          this.inputForm.action = '03'
          break;
      }
    },
    changeSite() {
