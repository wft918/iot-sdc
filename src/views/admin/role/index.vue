    ...
    getList(page, params) {
     ...
     //获取租户信息
      handleCommand (command) {
        ...
        if(this.tenantId != 1) {
          this.roleManager_btn_edit = false;
          this.roleManager_btn_del = false;
          this.roleManager_btn_perm = false;
        }  
        if(this.tenantId == 1){
          this.roleManager_btn_edit = true;
          this.roleManager_btn_del = true;
          this.roleManager_btn_perm = true;
        }
