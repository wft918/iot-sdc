<template>
  <div class="top">
    ...
    <div class="bgImage"><img src="../../public/img/firstPage.png" alt=""></div>
    <!-- <basic-container>
      <div class="banner-text">
        <span>
          ...
          <img src="https://img.shields.io/badge/Spring%20Boot-2.2.4.RELEASE-yellowgreen.svg" alt="Downloads">
        ...
        <span>
          <el-collapse v-model="activeNames">
            <el-collapse-item title="完整的微服务架构" name="1">
              ...
              <div>基于Spring Boot 2.2.4.RELEASE</div>
            </el-collapse-item>
...
export default {
  ...
  mounted() {
    // console.log(document.getElementById("tab-/wel/index"))
    // document.getElementById("tab-/wel/index").classList.add('is-active')
  }
}
</script>
